        ...
        <div className="min-h-screen bg-white text-black p-8 max-w-4xl mx-auto print:p-0 print:max-w-none">
            ...
            <div className="mb-8 border-b-2 border-black pb-4 flex justify-between items-end">
                <div>
                    ...
                    <div className="mt-2 text-[10px] text-gray-500 max-w-md leading-tight">
                        This report was generated by the user for personal tracking purposes.
                        Vicessa does not provide medical advice or clinical interpretation.
                    </div>
                </div>
            ...
            <div className="mt-12 pt-4 border-t border-gray-200 text-center text-xs text-gray-400 print:text-black">
                <p>This report was generated by the user for personal tracking purposes. Vicessa does not provide medical advice or clinical interpretation.</p>
