                    ...
                    return (
                        <button
                            ...
                            className={cn(
                                ...
                                isActive
                                    ? "bg-[var(--color-brand-primary)] text-white border-transparent shadow-md"
                                    : "bg-white text-gray-600 border-gray-200 hover:border-[var(--color-brand-gold)] hover:bg-gray-50"
                            )}
                        >
                            {option}
                        </button>
